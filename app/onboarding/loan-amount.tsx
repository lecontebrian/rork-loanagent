...
const styles = StyleSheet.create({
  ...
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: 20, borderWidth: 2, borderColor: colors.primary, paddingHorizontal: 24, paddingVertical: 8 },
  input: { flex: 1, fontSize: 48, fontWeight: '700' as const, color: colors.text, marginLeft: 8 },
  errorText: { fontSize: 14, color: colors.error, marginTop: 8, marginLeft: 4 },
  presetsContainer: { marginBottom: 32 },
  presetsTitle: { fontSize: 16, fontWeight: '600' as const, color: colors.text, marginBottom: 12 },
  presets: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  presetButton: { paddingHorizontal: 20, paddingVertical: 12, backgroundColor: colors.surface, borderRadius: 12, borderWidth: 2, borderColor: colors.border },
  presetButtonActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  presetText: { fontSize: 15, fontWeight: '600' as const, color: colors.text },
  presetTextActive: { color: colors.white },
  termsSection: { marginBottom: 24 },
  termsSectionTitle: { fontSize: 20, fontWeight: '700' as const, color: colors.text, marginBottom: 4 },
  termsSectionSubtitle: { fontSize: 14, color: colors.textSecondary, marginBottom: 20 },
  termsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 20 },
  termCard: { backgroundColor: colors.white, borderRadius: 14, borderWidth: 2, borderColor: colors.border, padding: 14 },
  termCardActive: { borderColor: colors.primary, backgroundColor: colors.primary, ...colors.shadow },
  termHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  termMonths: { fontSize: 16, fontWeight: '700' as const, color: colors.text, textTransform: 'uppercase' },
  termMonthsActive: { color: colors.white },
  selectedBadge: { width: 24, height: 24, borderRadius: 12, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center' },
  selectedBadgeText: { fontSize: 14, fontWeight: '700' as const, color: colors.primary },
  termPayment: { fontSize: 24, fontWeight: '800' as const, color: colors.primary, marginBottom: 2 },
  termPaymentActive: { color: colors.white },
  termLabel: { fontSize: 11, fontWeight: '500' as const, color: colors.textSecondary, marginBottom: 8 },
  termLabelActive: { color: 'rgba(255,255,255,0.8)' },
  termDivider: { height: 1, backgroundColor: colors.border, marginBottom: 6 },
  termTotal: { fontSize: 12, fontWeight: '600' as const, color: colors.textSecondary },
  termTotalActive: { color: 'rgba(255,255,255,0.9)' },
  selectionCard: { backgroundColor: colors.white, borderRadius: 16, padding: 20, marginBottom: 24, borderWidth: 1, borderColor: colors.border },
  selectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  selectionTitle: { fontSize: 18, fontWeight: '700' as const, color: colors.text, marginLeft: 12 },
  selectionSubtitle: { fontSize: 14, color: colors.textSecondary, marginBottom: 20 },
  inputRow: { flexDirection: 'row', marginBottom: 16 },
  inputField: { marginBottom: 16 },
  inputLabel: { fontSize: 14, fontWeight: '600' as const, color: colors.text, marginBottom: 8 },
  textInput: { backgroundColor: colors.surface, borderRadius: 12, padding: 14, fontSize: 16, color: colors.text, borderWidth: 1, borderColor: colors.border },
  priceInputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: 12, paddingHorizontal: 14, borderWidth: 1, borderColor: colors.border },
  priceInput: { flex: 1, padding: 14, fontSize: 16, color: colors.text, marginLeft: 4 },
  propertyTypes: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  propertyTypeButton: { paddingHorizontal: 16, paddingVertical: 10, backgroundColor: colors.surface, borderRadius: 10, borderWidth: 1, borderColor: colors.border },
  propertyTypeButtonActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  propertyTypeText: { fontSize: 14, fontWeight: '600' as const, color: colors.text },
  propertyTypeTextActive: { color: colors.white },
  infoButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, marginTop: 4 },
  infoButtonText: { fontSize: 13, color: colors.primary, marginLeft: 6, fontWeight: '600' as const },
  customizeButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.white, padding: 16, borderRadius: 12, marginBottom: 16, borderWidth: 1, borderColor: colors.border },
  customizeButtonText: { flex: 1, fontSize: 16, fontWeight: '600' as const, color: colors.primary, marginLeft: 12 },
  customFieldsCard: { backgroundColor: colors.white, borderRadius: 16, padding: 20, marginBottom: 24, borderWidth: 1, borderColor: colors.border },
  customFieldsTitle: { fontSize: 18, fontWeight: '700' as const, color: colors.text, marginBottom: 4 },
  customFieldsSubtitle: { fontSize: 13, color: colors.textSecondary, marginBottom: 20 },
  averageRatesCard: { backgroundColor: colors.surface, borderRadius: 12, padding: 16, marginTop: 4 },
  averageRatesTitle: { fontSize: 14, fontWeight: '600' as const, color: colors.text, marginBottom: 12 },
  averageRatesRow: { flexDirection: 'row', justifyContent: 'space-around' },
  averageRateItem: { alignItems: 'center' },
  averageRateLabel: { fontSize: 12, color: colors.textSecondary, marginBottom: 4 },
  averageRateValue: { fontSize: 18, fontWeight: '700' as const, color: colors.text },
  termCardWrapper: { width: '48%' },
  termInfo: { fontSize: 11, color: colors.textSecondary, marginTop: 6, paddingHorizontal: 4, lineHeight: 15 },
  estimateDisclaimerCard: { flexDirection: 'row', backgroundColor: '#FFF9E6', padding: 16, borderRadius: 12, marginTop: 20, borderWidth: 1, borderColor: '#FFE69C' },
  estimateDisclaimerTitle: { fontSize: 13, fontWeight: '700' as const, color: colors.text, marginBottom: 4 },
  estimateDisclaimerText: { fontSize: 11, color: colors.textSecondary, lineHeight: 16 },
  footer: { padding: 24, borderTopWidth: 1, borderTopColor: colors.border, backgroundColor: colors.white },
  continueButton: { backgroundColor: colors.primary, paddingVertical: 18, borderRadius: 14, alignItems: 'center', ...colors.shadow },
  ...
  mortgageCalculatorCard: { backgroundColor: colors.white, borderRadius: 16, padding: 20, marginBottom: 24, borderWidth: 1, borderColor: colors.border },
  mortgageCalculatorTitle: { fontSize: 20, fontWeight: '700' as const, color: colors.text, marginBottom: 4 },
  mortgageCalculatorSubtitle: { fontSize: 14, color: colors.textSecondary, marginBottom: 24 },
  downPaymentSection: { marginBottom: 24, paddingBottom: 24, borderBottomWidth: 1, borderBottomColor: colors.border },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  sectionTitle: { fontSize: 16, fontWeight: '700' as const, color: colors.text },
  sectionValue: { fontSize: 18, fontWeight: '700' as const, color: colors.primary },
  sectionSubtitle: { fontSize: 13, color: colors.textSecondary, marginBottom: 16, lineHeight: 18 },
  percentageButtons: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 16 },
  percentageButton: { paddingHorizontal: 16, paddingVertical: 12, backgroundColor: colors.surface, borderRadius: 12, borderWidth: 2, borderColor: colors.border, minWidth: 70 },
  percentageButtonActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  percentageButtonText: { fontSize: 15, fontWeight: '700' as const, color: colors.text, textAlign: 'center', marginBottom: 2 },
  percentageButtonTextActive: { color: colors.white },
  percentageButtonAmount: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, textAlign: 'center' },
  percentageButtonAmountActive: { color: 'rgba(255,255,255,0.8)' },
  customPercentageInput: { marginTop: 8 },
  loanProgramSection: { marginBottom: 24, paddingBottom: 24, borderBottomWidth: 1, borderBottomColor: colors.border },
  loanProgramButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, padding: 16, borderRadius: 12, marginBottom: 12, borderWidth: 2, borderColor: colors.border },
  loanProgramButtonActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  loanProgramHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  loanProgramLabel: { fontSize: 16, fontWeight: '700' as const, color: colors.text },
  loanProgramLabelActive: { color: colors.white },
  loanProgramRate: { fontSize: 14, fontWeight: '700' as const, color: colors.primary },
  loanProgramRateActive: { color: colors.white },
  loanProgramDescription: { fontSize: 12, color: colors.textSecondary },
  loanProgramDescriptionActive: { color: 'rgba(255,255,255,0.9)' },
  checkmark: { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center', marginLeft: 12 },
  checkmarkText: { fontSize: 16, fontWeight: '700' as const, color: colors.primary },
  customRateInput: { marginTop: 8 },
  inputHint: { fontSize: 11, color: colors.textSecondary, marginTop: 4 },
  pmiSection: { marginBottom: 24, paddingBottom: 24, borderBottomWidth: 1, borderBottomColor: colors.border },
  pmiHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  toggleSwitch: { padding: 4 },
  ...
  toggleThumb: { width: 24, height: 24, borderRadius: 12, backgroundColor: colors.white, ...colors.shadow },
  toggleThumbActive: { alignSelf: 'flex-end' },
  additionalCostsSection: { marginBottom: 24, paddingBottom: 24, borderBottomWidth: 1, borderBottomColor: colors.border },
  utilitiesSection: { marginBottom: 0 },
  utilityRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
  utilityCheckbox: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  ...
  checkboxCheck: { fontSize: 14, fontWeight: '700' as const, color: colors.white },
  utilityLabel: { fontSize: 15, fontWeight: '600' as const, color: colors.text },
  utilityInputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: 8, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.border, width: 100 },
  dollarSign: { fontSize: 16, fontWeight: '600' as const, color: colors.textSecondary, marginRight: 4 },
  utilityInput: { flex: 1, paddingVertical: 8, fontSize: 16, fontWeight: '600' as const, color: colors.text },
  termsSectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 },
  breakdownButton: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.primary, borderRadius: 8 },
  breakdownButtonText: { fontSize: 13, fontWeight: '600' as const, color: colors.white },
  paymentBreakdownCard: { backgroundColor: colors.surface, borderRadius: 12, padding: 16, marginBottom: 20 },
  breakdownTitle: { fontSize: 16, fontWeight: '700' as const, color: colors.text, marginBottom: 16 },
  ...
  breakdownValue: { fontSize: 15, fontWeight: '600' as const, color: colors.text },
  breakdownDivider: { height: 1, backgroundColor: colors.border, marginVertical: 12 },
  breakdownLabelTotal: { fontSize: 16, fontWeight: '700' as const, color: colors.text },
  breakdownValueTotal: { fontSize: 18, fontWeight: '800' as const, color: colors.primary },
  homePaymentDisplay: { marginBottom: 20 },
  homePaymentCard: { backgroundColor: colors.primary, borderRadius: 16, padding: 24, alignItems: 'center', ...colors.shadow },
  homePaymentLabel: { fontSize: 14, fontWeight: '600' as const, color: 'rgba(255,255,255,0.8)', marginBottom: 8 },
  homePaymentAmount: { fontSize: 42, fontWeight: '800' as const, color: colors.white, marginBottom: 16 },
  homePaymentDetails: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 16 },
  homePaymentDetail: { fontSize: 12, fontWeight: '600' as const, color: 'rgba(255,255,255,0.9)' },
});
