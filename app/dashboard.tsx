...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 15, color: colors.textSecondary, fontWeight: '500' as const, letterSpacing: -0.2 },
  name: { fontSize: 32, fontWeight: '700' as const, color: colors.text, marginTop: 2, letterSpacing: -0.6 },
  headerButtons: { flexDirection: 'row', gap: 10 },
  notificationButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', ...colors.shadow },
  ...
  settingsButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', ...colors.shadow },
  creditCard: { marginHorizontal: 28, marginBottom: 28, borderRadius: 24, overflow: 'hidden', ...colors.shadowStrong },
  creditGradient: { padding: 28 },
  creditHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  creditLabel: { fontSize: 13, fontWeight: '600' as const, color: 'rgba(255,255,255,0.85)', textTransform: 'uppercase', letterSpacing: 0.8 },
  creditTrend: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12 },
  creditTrendText: { fontSize: 13, fontWeight: '700' as const, color: colors.white },
  creditScoreContainer: { flexDirection: 'row', alignItems: 'flex-end', gap: 12 },
  creditScore: { fontSize: 64, fontWeight: '800' as const, color: colors.white, letterSpacing: -2 },
  creditInfo: { paddingBottom: 8, gap: 8 },
  creditRatingBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, alignSelf: 'flex-start' as const },
  creditRatingText: { fontSize: 11, fontWeight: '700' as const, color: colors.white, letterSpacing: 0.5 },
  creditMaxScore: { fontSize: 17, fontWeight: '600' as const, color: 'rgba(255,255,255,0.75)' },
  ongoingSection: { marginHorizontal: 28, marginBottom: 24 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  ongoingSectionTitle: { fontSize: 22, fontWeight: '700' as const, color: colors.text, letterSpacing: -0.4 },
  viewAllText: { fontSize: 15, fontWeight: '500' as const, color: colors.white },
  ongoingCard: { padding: 24, backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.border, ...colors.shadowMedium },
  ...
  ongoingLoanType: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, letterSpacing: 0.5, marginTop: 2 },
  ...
  ongoingAmount: { fontSize: 36, fontWeight: '800' as const, color: colors.text, marginBottom: 8, letterSpacing: -1 },
  ...
  applyButton: { marginHorizontal: 28, marginBottom: 32, borderRadius: 20, overflow: 'hidden', ...colors.shadowMedium },
  ...
  sectionTitle: { fontSize: 22, fontWeight: '700' as const, color: colors.text, marginBottom: 16, letterSpacing: -0.4 },
  ...
  applicationCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  ...
  applicationType: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, letterSpacing: 0.5, marginTop: 2 },
  ...
  applicationAmount: { fontSize: 28, fontWeight: '700' as const, color: colors.text, marginBottom: 6, letterSpacing: -0.6 },
  applicationDetails: { fontSize: 14, fontWeight: '500' as const, color: colors.textSecondary },
  statsGrid: { flexDirection: 'row', gap: 14 },
  statCard: { flex: 1, padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  statColorBar: { width: 32, height: 4, borderRadius: 2, marginBottom: 16 },
  statValue: { fontSize: 26, fontWeight: '700' as const, color: colors.text, marginBottom: 6, letterSpacing: -0.5 },
  statLabel: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary },
  refinanceBanner: { marginHorizontal: 28, marginBottom: 20, borderRadius: 24, overflow: 'hidden', ...colors.shadowStrong },
  ...
  refinanceBadgeText: { fontSize: 11, fontWeight: '700' as const, color: colors.white, letterSpacing: 0.8 },
  refinanceTitle: { fontSize: 15, fontWeight: '600' as const, color: 'rgba(255,255,255,0.85)', marginBottom: 8 },
  refinanceSavings: { fontSize: 48, fontWeight: '800' as const, color: colors.white, marginBottom: 6, letterSpacing: -1.5 },
  ...
  metricCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.border, ...colors.shadowMedium },
  ...
  metricValue: { fontSize: 32, fontWeight: '800' as const, color: colors.text, marginBottom: 10, letterSpacing: -1 },
  ...
  creditScoreValue: { fontSize: 44, fontWeight: '800' as const, color: colors.white, letterSpacing: -1.5, marginBottom: 8, textShadowColor: 'rgba(0,0,0,0.15)', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 4 },
  creditScoreLabelRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  creditScoreLabelDot: { width: 6, height: 6, borderRadius: 3 },
  creditScoreLabelText: { fontSize: 11, fontWeight: '700' as const, color: 'rgba(255,255,255,0.9)', letterSpacing: 0.8 },
  offersSection: { marginBottom: 28 },
  offersScrollContent: { paddingHorizontal: 28, gap: 14 },
  offerCard: { width: width - 80, padding: 24, backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.border, ...colors.shadowMedium },
  ...
  offerLenderName: { fontSize: 20, fontWeight: '700' as const, color: colors.text, marginBottom: 4, letterSpacing: -0.4 },
  offerType: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, letterSpacing: 0.5, marginBottom: 20 },
  ...
  offerDetailValue: { fontSize: 22, fontWeight: '700' as const, color: colors.text, letterSpacing: -0.4 },
  ...
  creditHealthCard: { padding: 24, backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.border, ...colors.shadowMedium },
  ...
  accountsList: { gap: 14 },
  accountCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  ...
  accountType: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, letterSpacing: 0.5, marginTop: 2 },
  ...
  accountBalanceValue: { fontSize: 24, fontWeight: '700' as const, color: colors.text, letterSpacing: -0.5 },
  ...
  featureCard: { width: '22%', aspectRatio: 1, padding: 12, backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', ...colors.shadow },
  ...
  affiliateSection: { marginHorizontal: 28, marginBottom: 28, borderRadius: 24, overflow: 'hidden', ...colors.shadowStrong },
  ...
  affiliateTitle: { fontSize: 24, fontWeight: '800' as const, color: colors.white, marginBottom: 8, letterSpacing: -0.5 },
  ...
  affiliateDashboardCard: { marginHorizontal: 28, marginBottom: 28, borderRadius: 24, overflow: 'hidden', ...colors.shadowStrong },
  ...
  affiliateDashboardBadgeText: { fontSize: 11, fontWeight: '700' as const, color: colors.white, letterSpacing: 0.8 },
  affiliateDashboardTitle: { fontSize: 26, fontWeight: '800' as const, color: colors.white, marginBottom: 20, letterSpacing: -0.6 },
  ...
  affiliateDashboardStatValue: { fontSize: 24, fontWeight: '800' as const, color: colors.white, marginBottom: 4, letterSpacing: -0.5 },
  ...
  pendingList: { gap: 14 },
  pendingCard: { backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.warning + '40', overflow: 'hidden', ...colors.shadowMedium },
  ...
  pendingLoanType: { fontSize: 11, fontWeight: '600' as const, color: colors.textSecondary, letterSpacing: 0.5, marginTop: 2 },
  ...
  pendingAmount: { fontSize: 28, fontWeight: '700' as const, color: colors.text, letterSpacing: -0.6 },
