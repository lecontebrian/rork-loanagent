...
const styles = StyleSheet.create({
  ...
  applicationLenderInfo: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  },
  applicationLenderLogo: {
    width: 36,
    height: 36,
    borderRadius: 10,
    backgroundColor: colors.surfaceTertiary,
  ...
  affiliateDashboardBadgeText: {
    fontSize: 11,
    fontWeight: '700' as const,
    color: colors.white,
    letterSpacing: 0.8,
  },
  affiliateDashboardTitle: {
    fontSize: 26,
    fontWeight: '800' as const,
    color: colors.white,
    marginBottom: 20,
  ...
  affiliateDashboardStat: {
    flex: 1,
    alignItems: 'center',
  },
  affiliateDashboardStatValue: {
    fontSize: 24,
    fontWeight: '800' as const,
    color: colors.white,
    marginBottom: 4,
  ...
  affiliateDashboardStatLabel: {
    fontSize: 12,
    fontWeight: '500' as const,
    color: 'rgba(255, 255, 255, 0.85)',
    letterSpacing: -0.1,
  },
  affiliateDashboardDivider: {
    width: 1,
    height: 32,
    backgroundColor: 'rgba(255, 255, 255, 0.25)',
  },
  affiliateDashboardCta: {
    fontSize: 14,
    fontWeight: '600' as const,
    color: 'rgba(255, 255, 255, 0.85)',
    textAlign: 'center',
