...
const styles = StyleSheet.create({
  ...
  bgAccent2: {
    ...
    height: 180,
    borderRadius: 90,
    backgroundColor: 'rgba(43, 128, 0, 0.04)',
  },
  container: {
    flex: 1,
  ...
  filterChipActive: {
    backgroundColor: CK_GREEN_DARK,
    borderColor: CK_GREEN_DARK,
  },
  filterDot: {
    width: 6,
    height: 6,
  ...
  paymentOptionActive: {
    borderColor: CK_GREEN,
    backgroundColor: 'rgba(91, 222, 0, 0.05)',
  },
  ...
  returnsTotalRow: {
    borderTopWidth: 1,
    borderTopColor: 'rgba(91, 222, 0, 0.2)',
    paddingTop: 12,
    marginTop: 4,
    marginBottom: 0,
  },
  ...
  tokenBadge: {
    ...
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(91, 222, 0, 0.25)',
  },
  tokenBadgeText: {
    fontSize: 14,
    fontWeight: '700' as const,
  ...
  investButtonCost: {
    ...
    alignItems: 'center',
    gap: 4,
    backgroundColor: 'rgba(91, 222, 0, 0.15)',
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 8,
    marginRight: 8,
  ...
  tokenCostBanner: {
    ...
    justifyContent: 'center',
    gap: 8,
    backgroundColor: 'rgba(91, 222, 0, 0.08)',
    paddingVertical: 12,
    paddingHorizontal: 16,
    borderRadius: 10,
    marginBottom: 16,
