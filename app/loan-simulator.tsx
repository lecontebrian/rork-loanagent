...
const styles = StyleSheet.create({
  ...
  infoCard: { flexDirection: 'row', padding: 18, backgroundColor: colors.infoLight, borderRadius: 16, gap: 14, marginBottom: 24 },
  infoIconContainer: { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.primaryLight, alignItems: 'center', justifyContent: 'center' },
  infoText: { flex: 1, fontSize: 14, fontWeight: '500' as const, color: colors.text, lineHeight: 20 },
  inputsSection: { marginBottom: 24 },
  advancedToggle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, marginBottom: 16, gap: 8 },
  advancedToggleText: { fontSize: 14, fontWeight: '600', color: colors.primary },
  advancedSection: { gap: 4 },
  sectionTitle: { fontSize: 20, fontWeight: '700' as const, color: colors.text, marginBottom: 16 },
  inputCard: { padding: 18, backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 12, ...colors.shadow },
  inputLabel: { fontSize: 14, fontWeight: '600' as const, color: colors.textSecondary, marginBottom: 10 },
  inputWrapper: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  inputPrefix: { fontSize: 20, fontWeight: '700' as const, color: colors.text },
  input: { flex: 1, fontSize: 20, fontWeight: '700' as const, color: colors.text },
  inputFull: { fontSize: 20, fontWeight: '700' as const, color: colors.text },
  sliderInfo: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 12 },
  sliderLabel: { fontSize: 12, fontWeight: '600' as const, color: colors.textTertiary },
  sliderBar: { flex: 1, height: 4, backgroundColor: colors.surfaceTertiary, borderRadius: 2, overflow: 'hidden' },
  ...
  pickerButtonText: { fontSize: 17, fontWeight: '600' as const, color: colors.text },
  pickerContainer: { padding: 12, backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 12, gap: 8 },
  pickerOption: { padding: 14, borderRadius: 10, backgroundColor: colors.background },
  pickerOptionText: { fontSize: 15, fontWeight: '500' as const, color: colors.textSecondary },
  pickerOptionTextActive: { color: colors.white, fontWeight: '600' as const },
  simulateButton: { marginBottom: 24, borderRadius: 18, overflow: 'hidden', ...colors.shadowMedium },
  simulateButtonGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 18, gap: 10 },
  simulateButtonText: { fontSize: 18, fontWeight: '700' as const, color: colors.white },
  resultsSection: { gap: 16 },
  resultCard: { borderRadius: 20, overflow: 'hidden', ...colors.shadowStrong },
  resultGradient: { padding: 24 },
  resultLabel: { fontSize: 15, fontWeight: '600' as const, color: 'rgba(255,255,255,0.9)', marginBottom: 8 },
  resultValue: { fontSize: 56, fontWeight: '800' as const, color: colors.white, marginBottom: 16, letterSpacing: -1.5 },
  resultProgressBar: { height: 6, backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: 3, overflow: 'hidden' },
  resultProgressFill: { height: '100%', backgroundColor: colors.white, borderRadius: 3 },
  resultMetrics: { flexDirection: 'row', gap: 12 },
  resultMetricCard: { flex: 1, padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  resultMetricLabel: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary, marginBottom: 8 },
  resultMetricValue: { fontSize: 24, fontWeight: '800' as const, color: colors.text },
  affordabilityCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  affordabilityHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 12 },
  affordabilityTitle: { fontSize: 16, fontWeight: '600' as const, color: colors.text },
  affordabilityValue: { fontSize: 36, fontWeight: '800' as const, color: colors.text, marginBottom: 12, letterSpacing: -1 },
  affordabilityBar: { height: 8, backgroundColor: colors.surfaceTertiary, borderRadius: 4, overflow: 'hidden' },
  affordabilityFill: { height: '100%', borderRadius: 4 },
  recommendationsCard: { padding: 20, backgroundColor: colors.warningLight, borderRadius: 18, gap: 14 },
  recommendationsHeader: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  recommendationsTitle: { fontSize: 16, fontWeight: '700' as const, color: colors.text },
  recommendation: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  recommendationText: { flex: 1, fontSize: 14, fontWeight: '500' as const, color: colors.text, lineHeight: 20 },
});
