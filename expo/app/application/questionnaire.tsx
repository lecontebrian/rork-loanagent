...
const styles = StyleSheet.create({
  ...
  backButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', ...colors.shadow },
  headerTitleContainer: { flex: 1, alignItems: 'center' },
  headerTitle: { fontSize: 17, fontWeight: '600' as const, color: colors.text },
  progressContainer: { paddingHorizontal: 28, paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: colors.border },
  progressBar: { height: 6, backgroundColor: colors.surfaceTertiary, borderRadius: 3, overflow: 'hidden', marginBottom: 10 },
  progressFill: { height: '100%' },
  progressGradient: { flex: 1 },
  progressText: { fontSize: 13, fontWeight: '600' as const, color: colors.textSecondary, textAlign: 'center' },
  scrollView: { flex: 1 },
  content: { paddingHorizontal: 28, paddingTop: 28 },
  stepHeader: { alignItems: 'center', marginBottom: 32 },
  stepIcon: { width: 64, height: 64, borderRadius: 32, backgroundColor: colors.primaryLight, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  stepTitle: { fontSize: 26, fontWeight: '700' as const, color: colors.text, marginBottom: 8, textAlign: 'center' },
  stepSubtitle: { fontSize: 16, fontWeight: '400' as const, color: colors.textSecondary, textAlign: 'center' },
  formContainer: { gap: 28 },
  section: { gap: 18 },
  sectionTitle: { fontSize: 18, fontWeight: '700' as const, color: colors.text },
  field: { gap: 8 },
  fieldLabel: { fontSize: 15, fontWeight: '600' as const, color: colors.text },
  input: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 14, paddingHorizontal: 18, paddingVertical: 14, fontSize: 16, fontWeight: '400' as const, color: colors.text },
  inputWithIcon: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 14, paddingHorizontal: 18, paddingVertical: 14, gap: 10 },
  inputWithIconInput: { flex: 1, backgroundColor: 'transparent', borderWidth: 0, padding: 0 },
  chipGroup: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  chip: { paddingHorizontal: 16, paddingVertical: 10, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 12 },
  ...
  checkboxCheck: { width: 12, height: 12, borderRadius: 4, backgroundColor: colors.white },
  checkboxLabel: { fontSize: 15, fontWeight: '500' as const, color: colors.text },
  helperText: { fontSize: 12, color: colors.textTertiary, marginTop: 6, lineHeight: 16 },
  footer: { padding: 28, borderTopWidth: 1, borderTopColor: colors.border },
  continueButton: { borderRadius: 16, overflow: 'hidden', ...colors.shadowMedium },
  continueButtonDisabled: { opacity: 0.5 },
  continueButtonGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 18, gap: 10 },
