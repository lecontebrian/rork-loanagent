...
const styles = StyleSheet.create({
  ...
  headerContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingBottom: 16, backgroundColor: colors.surface, borderBottomWidth: 1, borderBottomColor: colors.border },
  backButton: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
  headerTitle: { fontSize: 18, fontWeight: '700' as const, color: colors.text },
  scrollContent: { paddingHorizontal: 20, paddingTop: 20 },
  tierCard: { marginBottom: 24, borderRadius: 24, overflow: 'hidden', ...colors.shadowStrong },
  tierGradient: { padding: 28 },
  tierBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start' as const, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.25)', marginBottom: 16 },
  tierBadgeText: { fontSize: 11, fontWeight: '700' as const, color: colors.white, letterSpacing: 0.8 },
  tierTitle: { fontSize: 15, fontWeight: '600' as const, color: 'rgba(255,255,255,0.85)', marginBottom: 8 },
  tierReferrals: { fontSize: 40, fontWeight: '800' as const, color: colors.white, marginBottom: 20, letterSpacing: -1.2 },
  tierProgressBar: { height: 6, backgroundColor: 'rgba(255,255,255,0.25)', borderRadius: 3, overflow: 'hidden', marginBottom: 10 },
  tierProgressFill: { height: '100%', backgroundColor: colors.white, borderRadius: 3 },
  tierProgressText: { fontSize: 13, fontWeight: '500' as const, color: 'rgba(255,255,255,0.85)' },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 28 },
  statCard: { width: (width - 52) / 2, padding: 18, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  ...
  viewAllText: { fontSize: 14, fontWeight: '500' as const, color: colors.textSecondary },
  linkCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, gap: 16, ...colors.shadow },
  linkTextContainer: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, paddingHorizontal: 16, backgroundColor: colors.primaryLight, borderRadius: 12 },
  linkText: { flex: 1, fontSize: 14, fontWeight: '500' as const, color: colors.primary },
  linkActions: { flexDirection: 'row', gap: 10 },
  linkButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 12, borderRadius: 12, backgroundColor: colors.primaryLight },
  linkButtonText: { fontSize: 15, fontWeight: '600' as const, color: colors.primary },
  periodSelector: { flexDirection: 'row', gap: 8 },
  periodButton: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: colors.surfaceTertiary },
  periodButtonActive: { backgroundColor: colors.primary },
  periodButtonText: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary },
  periodButtonTextActive: { color: colors.white },
  analyticsCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  analyticsRow: { flexDirection: 'row', gap: 20 },
  analyticsItem: { flex: 1, alignItems: 'center', gap: 8 },
  analyticsIcon: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  analyticsValue: { fontSize: 24, fontWeight: '700' as const, color: colors.text },
  analyticsLabel: { fontSize: 12, fontWeight: '500' as const, color: colors.textSecondary },
  analyticsDivider: { height: 1, backgroundColor: colors.border, marginVertical: 16 },
  analyticsFooter: { flexDirection: 'row', paddingTop: 16 },
  analyticsFooterItem: { flex: 1, alignItems: 'center' },
  analyticsFooterDivider: { width: 1, backgroundColor: colors.border, marginHorizontal: 16 },
  analyticsFooterLabel: { fontSize: 12, fontWeight: '500' as const, color: colors.textSecondary, marginBottom: 6 },
  analyticsFooterValue: { fontSize: 20, fontWeight: '700' as const, color: colors.text },
  referralsList: { gap: 12 },
  referralCard: { padding: 18, backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  referralHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  referralInfo: { flex: 1 },
  referralName: { fontSize: 16, fontWeight: '600' as const, color: colors.text, marginBottom: 4 },
  referralDate: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary },
  referralStatusBadge: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  referralStatusText: { fontSize: 12, fontWeight: '600' as const, textTransform: 'capitalize' },
  referralFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  referralCommission: { fontSize: 14, fontWeight: '600' as const, color: colors.success },
  referralLoanAmount: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary },
  commissionCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, gap: 12, ...colors.shadow },
  benefitItem: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  benefitBullet: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.success, marginTop: 6 },
  benefitText: { flex: 1, fontSize: 14, fontWeight: '500' as const, color: colors.text, lineHeight: 20 },
  tiersList: { gap: 14 },
  tierListCard: { padding: 20, backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, ...colors.shadow },
  tierListCardActive: { borderWidth: 2, borderColor: colors.primary },
  tierListHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  tierColorDot: { width: 12, height: 12, borderRadius: 6 },
  tierListName: { fontSize: 18, fontWeight: '700' as const, color: colors.text },
  currentTierBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, backgroundColor: colors.primaryLight, marginLeft: 'auto' as const },
  currentTierText: { fontSize: 10, fontWeight: '700' as const, color: colors.primary, letterSpacing: 0.5 },
  tierListRequirement: { fontSize: 13, fontWeight: '500' as const, color: colors.textSecondary, marginBottom: 14 },
  tierListEarnings: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  tierListEarningsLabel: { fontSize: 14, fontWeight: '500' as const, color: colors.textSecondary },
  tierListEarningsValue: { fontSize: 16, fontWeight: '600' as const, color: colors.text },
  tierListBonus: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingTop: 12, marginTop: 12, borderTopWidth: 1, borderTopColor: colors.border },
  tierListBonusText: { fontSize: 13, fontWeight: '600' as const, color: colors.success },
});
